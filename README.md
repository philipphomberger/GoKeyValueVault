This is a small learning project to build a backend API Server that allow to encrypt strings and save them to a mongodb backend as entcryped key and decrypt them as well with the API.
